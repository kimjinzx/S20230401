...
public class InformationController {
	...
	public String detail(Article article, int category, Model model) {
		...
		List<Article> listReply = as.listReply(article);
	...
	public String updategood(Article article, int category, Model model) {
	...
	public String updatebad(Article article, int category, Model model) {
