...
<script type="text/javascript">
	function pwCheck(dontAlert = false) {
	...
	$(() => {
		$('#password, #passwordCheck').change(e => {
			$('#submit-button').attr('disabled', !pwCheck(true));
		});
	});
</script>
<style type="text/css">
	...
	<main class="full-height">
		...
		<div class="container display-flex justify-content-center align-items-center full-height">
			<div class="display-flex flex-direction-column justify-content-center align-items-center" style="border: 2.5px solid var(--subtheme); border-radius: 10px; padding: 20px;">
				<h2 class="color-subtheme align-self-flex-start">비밀번호 재설정</h2>
				<form name="frm" action="${pageContext.request.contextPath }/resetPasswordProc" method="post" onsubmit="return pwCheck();">
					...
					<div class="display-flex flex-direction-column justify-content-flex-start align-items-center">
						<div class="display-flex justify-content-flex-start align-items-center margin-10px margin-hor-0">
							<label for="password" class="font-size-16px font-weight-bolder margin-right-10px text-align-center">비밀번호</label>
							<input id="password" type="password" class="font-size-16px" name="password" style="min-width: 0; max-width: none; width: 240px;" autofocus required>
						</div>
						<div class="display-flex justify-content-flex-start align-items-center margin-10px margin-hor-0">
						...
						<button id="submit-button" type="submit" class="subtheme-button font-size-18px align-self-stretch" style="padding: 5px 20px; margin: 20px 0;" disabled>확인</button>
					</div>
				</form>
			</div>
		</div>
