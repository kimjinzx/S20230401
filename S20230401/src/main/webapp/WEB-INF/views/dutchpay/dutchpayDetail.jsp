...
<script type="text/javascript">
	...
	window.open("/joinForm?art_id="+${detail.art_id}+"&brd_id="+${detail.brd_id},"신청서","width=700px,height=800px,top=200px,left=400px");
		}
	};
...
<table class="JoinApply"> <!-- 거래신청하기  -->
	<tr><th>공동구매 참여하기<th></tr>
	<tr><th> 작성자 ${detail.mem_image} ${detail.mem_nickname } (${detail.mem_username })<th></tr>
		<c:forEach var="JML" items="">
	<tr><th>${JMR.mem_image } - ${JMR.mem_nickname }<th></tr> <!-- 여기 waiting으로 바꾸자 -->
		</c:forEach>
	<tr><td><input type="button" id="JF" value="신청하기"></td></tr>
</table> 
