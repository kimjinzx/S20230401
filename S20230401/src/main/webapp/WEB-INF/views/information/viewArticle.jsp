	...
	<main>
		<div class="container">
			<div style="height: 100px; display: flex; justify-content: flex-start; align-items: center; border: 2px solid var(--subtheme); border-radius: 10px; margin-bottom: 10px; padding: 0 10px">
				<span style="font-size: 32px; font-weight: bold; color: var(--subtheme);">${categoryName}</span>
			</div>
			<div id="art_title">
				<c:if test="${categoryType != null }">
					<span style="font-size: 14px; font-weight: bold; padding: 2.5px 5px; border-radius: 5px; border: 0; background-color: var(--subtheme); color: var(--subtheme-font);">${categoryType}</span>
				</c:if>
			...
			<div id="art_writer" style="display: flex; justify-content: flex-end; align-items: center;">
				<div style="display: flex; flex-direction: column; justify-content: flex-end; align-items: center;">
					<span style="font-size: 16px; font-weight: bold;">${article.member.mem_nickname }</span>
					<div style="display: flex; justify-content: flex-end; align-items: center;">
						<div style="display: flex; justify-content: center; align-items: center; flex-grow: 1;">
							...
							<span style="font-size: 12px;">${article.art_good }</span>
						</div>
						<div style="display: flex; justify-content: center; align-items: center; flex-grow: 1;">
						...
						<div style="display: flex; justify-content: center; align-items: center; flex-grow: 1;">
							...
							<span style="font-size: 12px;">${article.art_bad }</span>
						</div>
					</div>
				</div>
