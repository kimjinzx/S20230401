...
<body>
	<header>
		...
		<div id="topbar">
			...
			<div id="topmenu">
				<a class="adv-hover menuitem" href="listArticle?brd_id=1000">함께해요</a>
				...
				<div id="dropdown">
					...
					<div class="submenu-items">
						<div class="submenu">
							<a class="submenuitem adv-hover" href="listArticle?brd_id=1010">밥 / 카페</a>
							<a class="submenuitem adv-hover" href="listArticle?brd_id=1020">스포츠 / 운동</a>
							<a class="submenuitem adv-hover" href="listArticle?brd_id=1030">쇼핑</a>
							<a class="submenuitem adv-hover" href="listArticle?brd_id=1040">문화생활</a>
							<a class="submenuitem adv-hover" href="listArticle?brd_id=1050">취미생활</a>
							<a class="submenuitem adv-hover" href="listArticle?brd_id=1060">기타</a>
						</div>
						<div class="submenu">
