...
<style type="text/css">
	...
	div.tag-box-tag > span.tag-box-tag-value {
		font-size: inherit;
		font-weight: inherit;
		color: inherit;
		margin-right: 2.5px;
	}
	div.tag-box-tag > button.tag-box-tag-remove {
		border-radius: 50%;
		border: none;
		outline: none;
		width: 14px;
	...
	button.tag-box-tag-remove * {
		pointer-events: none;
	}
	button.tag-box-tag-remove > svg {
		...
		<form id="write-form" name="write-form" action="/board/${boardName }/writeProc" method="post" enctype="multipart/form-data" accept-charset="UTF-8" onsubmit="writeAction();">
			...
			<div class="form-group">
				...
				<div style="display: flex; justify-content: flex-start; align-content: center;">
					...
					<div class="input-box" style="margin-left: 20px; flex-grow: 1;">
			...
			<button type="submit" class="adv-hover">등록</button>
		</form>
	</div>
