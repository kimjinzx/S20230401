	...
	<h2>게시글 작성</h2>
		...
		<!-- <form action="writeArticle" method="post" name="frm"> -->
			<table>
				...
				<tr><th>태그1</th><td><input type="text" name="art_tag1" required="required"></td></tr>
				<tr><th>태그2</th><td><input type="text" name="art_tag2" required="required"></td></tr>
				<tr><th>태그3</th><td><input type="text" name="art_tag3" required="required"></td></tr>
				<tr><th>태그4</th><td><input type="text" name="art_tag4" required="required"></td></tr>
				<tr><th>태그5</th><td><input type="text" name="art_tag5" required="required"></td></tr>
