...
<body>
	...
	<c:if test="${page.startPage > page.pageBlock }">
		<a href="listEtcArticle?currentPage=${page.startPage-page.pageBlock}">[이전]</a>
	</c:if>
	<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
		<a href="listEtcArticle?currentPage=${i}">[${i}]</a>
	</c:forEach>
	<c:if test="${page.endPage < page.totalPage }">
		<a href="listEtcArticle?currentPage=${page.startPage+page.pageBlock}">[다음]</a>
	</c:if>	
