...
<body>
	...
	<main>
			<h1>함께 해요 게시판</h1>
			<h2>쇼핑</h2>
	<p>(게시글 수 : ${totalShoppingArticle}) <hr>
	...
	<c:if test="${page.startPage > page.pageBlock }">
		<a href="listShoppingArticle?currentPage=${page.startPage-page.pageBlock}">[이전]</a>
	</c:if>
	<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
		<a href="listShoppingArticle?currentPage=${i}">[${i}]</a>
	</c:forEach>
	<c:if test="${page.endPage < page.totalPage }">
		<a href="listShoppingArticle?currentPage=${page.startPage+page.pageBlock}">[다음]</a>
	</c:if>	
