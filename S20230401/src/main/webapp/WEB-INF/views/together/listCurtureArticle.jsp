...
<body>
	...
	<main>
			<h1>함께 해요 게시판</h1>
			<h2>문화생활</h2>
	<p>(게시글 수 : ${totalCurtureArticle}) <hr>
	...
	<c:if test="${page.startPage > page.pageBlock }">
		<a href="listCurtureArticle?currentPage=${page.startPage-page.pageBlock}">[이전]</a>
	</c:if>
	<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
		<a href="listCurtureArticle?currentPage=${i}">[${i}]</a>
	</c:forEach>
	<c:if test="${page.endPage < page.totalPage }">
		<a href="listCurtureArticle?currentPage=${page.startPage+page.pageBlock}">[다음]</a>
	</c:if>	
