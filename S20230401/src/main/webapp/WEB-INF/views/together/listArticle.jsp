...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/initializer.js"></script>
<script type="text/javascript">
	$(window).scroll(() => {
...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/preference.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/presets.css">
<style type="text/css">
body {
	width: 100%;
	display: grid;
	...
	grid-template-areas: "header header header" "leftside main rightside"
...
header>div#topbar>div#logo-div, header>div#topbar>div#top-right {
	width: 200px;
}
...
header>div#topbar>div#topmenu>a.menuitem:hover ~ div#dropdown, header>div#topbar>div#topmenu>div.menu-separator:hover 
	~ div#dropdown, header>div#topbar>div#topmenu>div#dropdown:hover {
	height: 192.5px;
}
...
<body>
	<header>
		<div id="usernav">
			...
			<a href="">회원가입</a>
			<a href="">마이페이지</a> -->
			<a href="">이용 약관</a> <a href="">개인정보 취급 방침</a>
		</div>
		<div id="topbar">
			<div id="logo-div" class="full-height"
				style="display: flex; justify-content: flex-start; align-items: center; padding: 0 10px;">
				<a id="logo" class="full-height" href="/"> <!-- <img class="full-height" src="image/ShareGo_forLight.png"/> -->
					<div
						style="width: auto; display: flex; flex-direction: column; justify-content: center; align-items: flex-end;">
						<img
							src="${pageContext.request.contextPath}/image/ShareGo_Img.png"
							style="height: 30px;"> <span
							style="font-size: 24px; font-weight: 900; margin: -5px 0 0 0;">ShareGo</span>
					</div>
				</a>
			</div>
			<div id="topmenu">
				<a class="adv-hover menuitem"
					href="${pageContext.request.contextPath}/board/together?category=1000">함께해요</a>
				...
				<div id="dropdown">
					...
					<div class="submenu-items">
						<div class="submenu">
							<a class="submenuitem adv-hover"
								href="${pageContext.request.contextPath}/board/together?category=1010">밥
								/ 카페</a> <a class="submenuitem adv-hover"
								href="${pageContext.request.contextPath}/board/together?category=1020">스포츠
								/ 운동</a> <a class="submenuitem adv-hover"
								href="${pageContext.request.contextPath}/board/together?category=1030">쇼핑</a>
							<a class="submenuitem adv-hover"
								href="${pageContext.request.contextPath}/board/together?category=1040">문화생활</a>
							<a class="submenuitem adv-hover"
								href="${pageContext.request.contextPath}/board/together?category=1050">취미생활</a>
							<a class="submenuitem adv-hover"
								href="${pageContext.request.contextPath}/board/together?category=1060">기타</a>
						</div>
						<div class="submenu">
							<a class="submenuitem adv-hover" href="">식료품</a> <a
								class="submenuitem adv-hover" href="">의류 / 잡화</a> <a
								class="submenuitem adv-hover" href="">생활용품</a> <a
								class="submenuitem adv-hover" href="">해외배송</a> <a
								class="submenuitem adv-hover" href="">기타</a>
						</div>
						<div class="submenu">
							<a class="submenuitem adv-hover" href="">식품</a> <a
								class="submenuitem adv-hover" href="">패션 / 잡화</a> <a
								class="submenuitem adv-hover" href="">가전 / 가구</a> <a
								class="submenuitem adv-hover" href="">기타</a>
						</div>
						<div class="submenu">
							<a class="submenuitem adv-hover" href="">일상수다</a> <a
								class="submenuitem adv-hover" href="">자랑하기</a> <a
								class="submenuitem adv-hover" href="">홍보하기</a> <a
								class="submenuitem adv-hover" href="">질문 / 요청</a>
						</div>
						<div class="submenu">
							<a class="submenuitem adv-hover" href="">동네정보</a> <a
								class="submenuitem adv-hover" href="">구매정보</a> <a
								class="submenuitem adv-hover" href="">신규점포</a> <a
								class="submenuitem adv-hover" href="">지역활동</a>
						</div>
						<div class="submenu">
							<a class="submenuitem adv-hover" href="">공지</a> <a
								class="submenuitem adv-hover" href="">Q&A</a> <a
								class="submenuitem adv-hover" href="">이벤트</a> <a
								class="submenuitem adv-hover" href="">문의 / 건의</a>
						</div>
					</div>
					<div style="width: 200px;"></div>
				</div>
					...
					<c:choose>
						<c:when test="${1 == 1 }">
							...
							<div id="login-popup" class="popup-window">
								<button id="login-button" class="subtheme-button adv-hover"
									click="location.href = '/login';">로그인</button>
							</div>
						</c:when>
						<c:otherwise>
							<button id="userInfo" class="togglePopup adv-hover"></button>
							<div id="userInfo-popup" class="popup-window"></div>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
	...
	<main>
		...
		<table>
			...
			<c:forEach var="art" items="${listArticle }">
				<tr>
					...
					<td><img
						src="${pageContext.request.contextPath}/image/picture/${art.mem_image}"
						width="50" height="50" alt="사진이 없습니다"></td>
					<td>${art.art_read }</td>
					<td>${art.art_good }</td>
		...
		<button id="scrollToTop" class="adv-hover">
			<svg
				style="fill: var(- -subtheme); stroke: var(- -subtheme); stroke-width: 2px; stroke-linecap: round; stroke-linejoin: round;"
				width="20" height="10" viewBox="0 0 32 16">
	...
	<footer>
		<div id="footer-info" class="full-height">
			<span
				style="font-size: 40px; font-weight: 900; margin: 0 10px; text-align: left; opacity: 0.5;">ShareGo</span>
			...
			<div>
				<a href="" style="margin: 10px;"> <svg
						style="fill: var(- -theme-font);" width="30" height="30"
						viewBox="0 0 512 512">
						<path
							d="M480 257.35c0-123.7-100.3-224-224-224s-224 100.3-224 224c0 111.8 81.9 204.47 189 221.29V322.12h-56.89v-64.77H221V208c0-56.13 33.45-87.16 84.61-87.16 24.51 0 50.15 4.38 50.15 4.38v55.13H327.5c-27.81 0-36.51 17.26-36.51 35v42h62.12l-9.92 64.77H291v156.54c107.1-16.81 189-109.48 189-221.31z"
							fill-rule="evenodd" />
					</svg>
				</a> <a href="" style="margin: 10px;"> <svg
						style="stroke: var(- -theme-font);" width="30" height="30"
						viewBox="0 0 512 512">
						<path
