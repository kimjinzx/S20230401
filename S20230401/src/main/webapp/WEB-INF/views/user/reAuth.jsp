	...
	<main class="full-height">
		...
		<div class="container display-flex justify-content-center align-items-center full-height">
			<div class="display-flex flex-direction-column justify-content-center align-items-center" style="border: 2.5px solid var(--subtheme); border-radius: 10px; padding: 20px;">
				<h2 class="color-subtheme align-self-flex-start">비밀번호 확인</h2>
				<form action="${pageContext.request.contextPath }/user/comparePW">
					<div class="display-flex flex-direction-column justify-content-flex-start align-items-center">
						<div class="display-flex justify-content-flex-start align-items-center">
							...
							<label for="password" class="font-size-20px font-weight-bolder margin-right-10px">비밀번호</label>
							<input type="password" class="font-size-20px" name="password" style="min-width: 0; max-width: none; width: 240px;" autofocus required>
						</div>
