...
<style type="text/css">
	...
	div.container div.popup-group > button.togglePopup {
		width: 120px;
		height: 32px;
		overflow: hidden;
		margin: 0;
	...
	div.container div.popup-group > div.popup-window {
		position: absolute;
		border-radius: 2.5px;
		background-color: var(--theme);
	...
	div.container div.popup-window > div > button {
		width: 116px;
		border: none;
		outline: none;
		font-size: 14px;
				...
				<form id="join-form" action="/updateMemberProc" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div id="logo-div" class="full-height" style="display: flex; justify-content: center; align-items: center; padding: 0 10px;">
							<h2 class="color-subtheme">유저정보 수정</h2>
						</div>
						<div class="input-box">
						...
						<div class="input-box">
							...
							<div style="flex-grow: 1; flex-direction: column; justify-content: space-evenly; align-items: flex-start;">
								...
								<div style="display: flex; justify-content: flex-start; align-items: stretch;">
									<button type="button" style="font-size: 14px; padding: 2.5px 5px;" class="subtheme-button" onclick="document.getElementById('image-file').click();">업로드</button>
									<button type="button" style="margin-left: 10px; font-size: 14px; padding: 2.5px 5px;" class="theme-button" onclick="$('#image-file').val(''); $('#user-profile').attr('src', '');">초기화</button>
								</div>
							</div>
						</div>
						<div class="input-box">
